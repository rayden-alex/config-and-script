...
c:\Rip\ffmpeg\bin\ffmpeg.exe -hide_banner -i "%~n1.m4a" -c:v copy -c:a flac -f flac - | c:\Rip\opus-tools\opusenc.exe --quiet --music --vbr --bitrate 192 - "%~n1.opus" && c:\Rip\opus-tools\touch.exe -acm -r "%~n1.m4a" "%~n1.opus" && c:\Rip\opus-tools\Recycle.exe -f "%~n1.m4a"
goto :eof
